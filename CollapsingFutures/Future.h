...
/// @abstract A Future is a result that may fail and may not be ready yet.
///
/// @discussion
...
///
/// Future is a collapsing type: you never see a future containing a future result.
...
/// If the continuation returns a future, automatic collapse is triggered and the returned future will match it instead of having it as a result.
-(Future *)finally:(id(^)(Future * completed))completionContinuation;
...
-(void) finallyDo:(void(^)(Future * completed))completionHandler;
